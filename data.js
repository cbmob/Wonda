...
const LESSON_GUIDE_DATA = [
  ...
  { className:'g3', title:'3. ストレッチ', html:`<p>身体のケアも怠らないようにしましょう。前屈、開脚、首を回すなど簡単なことでも構いませんので、毎日実施してください。</p>` },
  { className:'g4', title:'4. 日々の積み重ね', html:`<p>基礎練、音楽を聴く、ダンサーの動画を観る、自分のノートを見返す。毎日少しでもダンスに触れることが大事です。</p><p>どこまでやるかは個人の自由。その上で、選抜のみなさんにはこのカルチャーで本気になることの素晴らしさも知ってもらいたいと思っています。</p>` }
];
